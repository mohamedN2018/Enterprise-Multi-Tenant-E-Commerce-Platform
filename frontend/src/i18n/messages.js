...
export default {
  ar: {
    ...
    orderDetailPage: {
      ...
      trackingAdded: 'تمت إضافة معلومات التتبّع.', markShipped: 'تحديد كمشحون', qty: 'الكمية', unitPrice: 'سعر الوحدة', posSynced: 'تم إرسال الطلب لنظام الكاشير',
  ...
  en: {
    ...
    orderDetailPage: {
      ...
      trackingAdded: 'Tracking info added.', markShipped: 'Mark shipped', qty: 'Qty', unitPrice: 'Unit price', posSynced: 'Order sent to the cashier system',
