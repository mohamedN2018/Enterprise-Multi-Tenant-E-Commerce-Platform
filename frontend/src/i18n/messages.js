...
export default {
  ar: {
    ...
    prod: {
      ...
      startingPrice: 'السعر', startingPriceHint: 'يُضاف كمتغيّر افتراضي للمنتج فورًا.', initialStock: 'الكمية المتاحة',
  ...
  en: {
    ...
    prod: {
      ...
      startingPrice: 'Price', startingPriceHint: "Added as the product's default variant right away.", initialStock: 'Stock on hand',
