...
export default {
  ar: {
    ...
    "posPage": {"linked":"مرتبط","notLinked":"غير مرتبط","subtitle":"اربط نظام الكاشير (نقطة البيع) بالمخزن: كل عملية بيع في المحل بتخصم من نفس المخزون تلقائيًا، وأي بيع أونلاين ممكن يترجّع للكاشير.","link":"اربط الكاشير","noPermission":"تحتاج صلاحية الإعدادات لربط الكاشير.","keyOnce":"انسخ المفتاح الآن — لن يظهر مرة أخرى.","copy":"نسخ","copied":"تم النسخ.","copyFailed":"تعذّر النسخ.","currentKey":"المفتاح الحالي","endpointsTitle":"روابط ربط الكاشير","headerHint":"أرسل المفتاح في ترويسة","webhook":"رابط المزامنة (Webhook)","webhookHint":"اختياري — هنبعت تحديثات المخزون لهذا الرابط عند أي بيع أونلاين.","saveWebhook":"حفظ الرابط","rotate":"تجديد المفتاح","unlink":"فصل الكاشير","unlinkConfirm":"فصل الكاشير؟ المفتاح الحالي هيتوقف عن العمل.","linkedToast":"تم ربط الكاشير.","rotatedToast":"تم إصدار مفتاح جديد.","webhookSaved":"تم حفظ رابط المزامنة.","unlinkedToast":"تم فصل الكاشير."},
  ...
  en: {
    ...
    "posPage": {"linked":"Linked","notLinked":"Not linked","subtitle":"Link your cashier (POS) to the warehouse: every in-store sale deducts from the same stock automatically, and online sales can sync back to the cashier.","link":"Link cashier","noPermission":"You need the settings permission to link a cashier.","keyOnce":"Copy the key now — it won't be shown again.","copy":"Copy","copied":"Copied.","copyFailed":"Couldn't copy.","currentKey":"Current key","endpointsTitle":"Cashier connection endpoints","headerHint":"Send the key in the header","webhook":"Sync webhook URL","webhookHint":"Optional — we POST stock updates here on every online sale.","saveWebhook":"Save webhook","rotate":"Rotate key","unlink":"Unlink cashier","unlinkConfirm":"Unlink the cashier? The current key will stop working.","linkedToast":"Cashier linked.","rotatedToast":"A new key was issued.","webhookSaved":"Sync webhook saved.","unlinkedToast":"Cashier unlinked."},
