...
export default {
  ar: {
    ...
    checkout: {
      ...
      deliveryLocation: 'موقع التوصيل', pickLocation: 'حدّد موقعك على الخريطة لنتأكد أنه داخل نطاق التوصيل.', locationSet: 'تم تحديد موقعك ✓',
      deliveryAvailable: 'رائع! التوصيل متاح إلى موقعك.', deliveryUnavailable: 'عذرًا، هذا المتجر لا يوصّل إلى منطقتك. جرّب موقعًا أقرب أو متجرًا آخر.',
      deliveryUnavailableShort: 'التوصيل غير متاح في منطقتك', storeUnavailable: 'هذا المتجر لا يستقبل طلبات حاليًا.',
    ...
    orderDetailPage: {
      ...
      trackingAdded: 'تمت إضافة معلومات التتبّع.', markShipped: 'تحديد كمشحون', qty: 'الكمية', unitPrice: 'سعر الوحدة', posSynced: 'تم إرسال الطلب لنظام الكاشير', posSend: 'إرسال للكاشير', posResend: 'إعادة الإرسال للكاشير', posSent: 'تم إرسال الطلب للكاشير.', posNotConfirmed: 'لم يؤكّد الكاشير استلام الطلب. من فضلك حاول مرة أخرى.', posSyncedShort: 'مُرسل للكاشير',
    ...
    settingsPage: {
      ...
      dangerZone: 'منطقة الخطر', pauseStore: 'إيقاف المتجر مؤقتًا', resumeStore: 'إعادة تشغيل المتجر',
      pauseHint: 'المتجر هيختفي من السوق ومش هيقدر حد يطلب منه، لحد ما تشغّله تاني.', resumeHint: 'رجّع المتجر يظهر للعملاء ويستقبل الطلبات.',
      pauseStore2: 'إيقاف', storePaused: 'تم إيقاف المتجر — أصبح مخفيًا عن الجميع.', storeResumed: 'تمت إعادة تشغيل المتجر.',
      deleteStore: 'حذف المتجر', deleteHint: 'المتجر هيتشال ويختفي عن الجميع. تقدر تطلب من الأدمن استرجاعه لاحقًا.',
      confirmDelete: 'متأكد إنك عايز تحذف المتجر؟ هيختفي عن الجميع فورًا.', storeDeleted: 'تم حذف المتجر.'
    },
    inventoryPage: {
    ...
    auth: {
      ...
      unifiedSubtitle: 'أهلاً بعودتك — سجّل دخولك للمتابعة.',
      autoRouteHint: 'عميل أو بائع أو مدير؟ فورم واحد — هنوصّلك لمكانك تلقائيًا.',
      emailNotVerified: 'لازم تفعّل بريدك الإلكتروني الأول قبل الدخول.',
      tooManyAttempts: 'محاولات كتيرة. استنى دقيقة وحاول تاني.',
  ...
  en: {
    ...
    checkout: {
      ...
      deliveryLocation: 'Delivery location', pickLocation: 'Pin your location on the map so we can confirm it is within the delivery area.', locationSet: 'Location set ✓',
      deliveryAvailable: 'Great! Delivery is available to your location.', deliveryUnavailable: 'Sorry, this store does not deliver to your area. Try a closer location or another store.',
      deliveryUnavailableShort: 'Delivery not available in your area', storeUnavailable: 'This store is not accepting orders right now.',
    ...
    orderDetailPage: {
      ...
      trackingAdded: 'Tracking info added.', markShipped: 'Mark shipped', qty: 'Qty', unitPrice: 'Unit price', posSynced: 'Order sent to the cashier system', posSend: 'Send to cashier', posResend: 'Re-send to cashier', posSent: 'Order sent to the cashier.', posNotConfirmed: 'The cashier did not confirm the order. Please try again.', posSyncedShort: 'Synced to cashier',
    ...
    settingsPage: {
      ...
      dangerZone: 'Danger zone', pauseStore: 'Pause store', resumeStore: 'Resume store',
      pauseHint: 'The store disappears from the marketplace and can’t take orders until you resume it.', resumeHint: 'Bring the store back so customers can see it and order.',
      storePaused: 'Store paused — now hidden from everyone.', storeResumed: 'Store resumed.',
      deleteStore: 'Delete store', deleteHint: 'The store is removed and hidden from everyone. You can ask the admin to restore it later.',
      confirmDelete: 'Delete this store? It disappears for everyone immediately.', storeDeleted: 'Store deleted.'
    },
    inventoryPage: {
    ...
    auth: {
      ...
      unifiedSubtitle: 'Welcome back — sign in to continue.',
      autoRouteHint: 'Customer, seller, or admin? One form — we route you automatically.',
