...
export default {
  ar: {
    ...
    prod: {
      ...
      image: 'صورة المنتج', chooseImage: 'اختر صورة', imageHint: 'JPG أو PNG حتى 5 ميجابايت.', descEn: 'الوصف (إنجليزي)',
  ...
  en: {
    ...
    prod: {
      ...
      image: 'Product image', chooseImage: 'Choose image', imageHint: 'JPG or PNG up to 5 MB.', descEn: 'Description (English)',
    ...
    admin: {
      ...
      seller: 'Seller', admin: 'Super Admin', viewStorefront: 'View storefront', selectStore: 'Select store', noStores: 'No stores yet',
