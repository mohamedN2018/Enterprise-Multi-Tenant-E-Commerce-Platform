...
export default {
  ar: {
    ...
    orderDetailPage: {
      ...
      trackingAdded: 'تمت إضافة معلومات التتبّع.', markShipped: 'تحديد كمشحون', qty: 'الكمية', unitPrice: 'سعر الوحدة', posSynced: 'تم إرسال الطلب لنظام الكاشير', posSend: 'إرسال للكاشير', posResend: 'إعادة الإرسال للكاشير', posSent: 'تم إرسال الطلب للكاشير.', posSyncedShort: 'مُرسل للكاشير',
  ...
  en: {
    ...
    orderDetailPage: {
      ...
      trackingAdded: 'Tracking info added.', markShipped: 'Mark shipped', qty: 'Qty', unitPrice: 'Unit price', posSynced: 'Order sent to the cashier system', posSend: 'Send to cashier', posResend: 'Re-send to cashier', posSent: 'Order sent to the cashier.', posSyncedShort: 'Synced to cashier',
